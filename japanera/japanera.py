...
from _strptime import (_calc_julian_from_U_or_W, _calc_julian_from_V, _cache_lock, _getlang, TimeRE, datetime_date, _CACHE_MAX_SIZE, _TimeRE_cache,
                       _regex_cache, _strptime_datetime)
import time
